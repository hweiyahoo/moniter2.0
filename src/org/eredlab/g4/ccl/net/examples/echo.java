...
/*******************************************************************************
 * This is an example program demonstrating how to use the EchoTCPClient and
 * EchoUDPClient classes. This program connects to the default echo service port
 * of a specified server, then reads lines from standard input, writing them to
 * the echo server, and then printing the echo. The default is to use the TCP
 * port. Use the -udp flag to use the UDP port.
 * <p>
...
public final class echo {
   ...
   public static final void echoUDP(String host) throws IOException {
      ...
      client.open();
      // If we don't receive an echo within 5 seconds, assume the packet is
      // lost.
