...
public class TelnetClientExample implements Runnable, TelnetNotificationHandler {
   ...
   public static void main(String[] args) throws IOException {
      ...
      TerminalTypeOptionHandler ttopt = new TerminalTypeOptionHandler("VT100", false,
            false, true, false);
      ...
      while (true) {
         ...
         try {
            ...
            // OptionHandler");
            // System.out.println("Type SPY to register the spy (connect to port
            // 3333 to spy)");
            ...
            do {
               try {
                  ...
                  if (ret_read > 0) {
                     if ((new String(buff, 0, ret_read)).startsWith("AYT")) {
                        try {
                           ...
                           System.err.println("Exception waiting AYT response: " + e
                                                    .getMessage());
                        }
                     }
                        ...
                        for (int ii = 0; ii < 25; ii++) {
                           ...
                           // tc.getLocalOptionState(ii) + " Remote Option " +
                           // ii + ":" + tc.getRemoteOptionState(ii));
                        }
                     }
                        ...
                        try {
                           ...
                           boolean acceptremote = (new Boolean(st.nextToken()))
                                 .booleanValue();
                           SimpleOptionHandler opthand = new SimpleOptionHandler(opcode,
                                 initlocal, initremote, acceptlocal, acceptremote);
                           tc.addOptionHandler(opthand);
                        }
                        catch (Exception e) {
                           if (e instanceof InvalidTelnetOptionException) {
                              System.err.println("Error registering option: " + e
                                                       .getMessage());
                           }
                           else {
                        ...
                        try {
                           ...
                           if (e instanceof InvalidTelnetOptionException) {
                              System.err.println("Error unregistering option: " + e
                                                       .getMessage());
                           }
                           else {
                  ...
                  System.err
                        .println("Exception while reading keyboard:" + e.getMessage());
                  end_loop = true;
               }
