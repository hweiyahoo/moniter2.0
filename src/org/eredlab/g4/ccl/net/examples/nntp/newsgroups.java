 ...
 * newsgroups command. It merely connects to the specified news server and
 * issues fetches the list of newsgroups stored by the server. On servers that
 * store a lot of newsgroups, this command can take a very long time (listing
 * upwards of 30,000 groups).
 * <p>
 ******************************************************************************/
