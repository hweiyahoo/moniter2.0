...
/*******************************************************************************
 * This is an example program demonstrating how to use the DaytimeTCP and
 * DaytimeUDP classes. This program connects to the default daytime service port
 * of a specified server, retrieves the daytime, and prints it to standard
 * output. The default is to use the TCP port. Use the -udp flag to use the UDP
 * port.
 * <p>
...
public final class daytime {
   ...
   public static final void daytimeTCP(String host) throws IOException {
      ...
      client.connect(host);
      logger.info(client.getTime().trim());
   ...
   public static final void daytimeUDP(String host) throws IOException {
      ...
      client.setDefaultTimeout(60000);
      client.open();
      logger.info(client.getTime(InetAddress.getByName(host)).trim());
