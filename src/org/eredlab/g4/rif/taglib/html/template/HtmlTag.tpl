...
<script type="text/javascript" src="${contextPath}/resource/commonjs/nms.js"></script>
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/css/nms_icon.css"/>
...
#end
#if(${usePortal} == "true")
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/myux/portal/css/Portal.css"/>
<link rel="stylesheet" type="text/css" href="${contextPath}/resource/css/portal_style.css"/>
<script type="text/javascript" src="${contextPath}/resource/myux/portal/MaximizeTool.js"></script>
<script type="text/javascript" src="${contextPath}/resource/myux/portal/Portal.js"></script>
<script type="text/javascript" src="${contextPath}/resource/myux/portal/PortalColumn.js"></script>
<script type="text/javascript" src="${contextPath}/resource/myux/portal/Portlet.js"></script>
<script type="text/javascript" src="${contextPath}/nms/portal/js/portalUtils.js"></script>
#end
