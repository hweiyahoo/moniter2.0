 ...
 * 响应树节点单击事件
 */
function addTab(url,name,menuid,pathCh,icon,flag){
  ...
  if (!n) {
	 ...
	 var imgSrc = '';
	 if(flag==1){
		imgSrc = './resource/image/nms/'+icon;
	 }else{
		imgSrc = './resource/image/ext/'+icon;
	 }
     n = mainTabs.add({
       id:id,
       title:"<img align='top' class='IEPNG' src='" + imgSrc + "'/>" + name,
       closable:true,
       layout:'fit',
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"  
	height="38" background="./resource/image/banner_background/${theme}.png">
	<tr >
...
<tr>
<td width="12%"><div align="right"><nobr>今天是:${date} ${week} <span id="rTime"><span></nobr></div></td>
<td width="53%"><nobr>&nbsp;<img class="IEPNG" src="./resource/image/ext/comments2.png" />&nbsp;欢迎您,${username}!&nbsp;帐户:${account}&nbsp;所属部门:${deptname}</nobr></td>
