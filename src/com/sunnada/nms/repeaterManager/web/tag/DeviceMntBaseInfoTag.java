 ...
 */
public class DeviceMntBaseInfoTag extends TagSupport {
   
   private static Log        log      = LogFactory.getLog(DeviceMntBaseInfoTag.class);
   ...
   public int doStartTag() throws JspException {
      ...
      dto.put("cmpwidth_1", (cmp_w - 126) / 5 + 60);
      dto.put("cmpwidth_2", (cmp_w - 126) / 5);
      dto.put("cmpwidth_3", (cmp_w - 126) / 5 - 70);
      dto.put("cmpwidth_4", (cmp_w - 126) / 5);
      dto.put("cmpwidth_5", (cmp_w - 126) / 5 - 10);
