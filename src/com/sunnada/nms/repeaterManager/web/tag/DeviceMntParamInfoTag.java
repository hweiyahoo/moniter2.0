 ...
 */
public class DeviceMntParamInfoTag extends TagSupport {
   
   private static Log        log      = LogFactory.getLog(DeviceMntParamInfoTag.class);
   ...
   public int doStartTag() throws JspException {
      ...
      dto.put("cmpwidth_1", (cmp_w - 66) / 4 + 60);
      dto.put("cmpwidth_2", (cmp_w - 66) / 4 - 30);
      dto.put("cmpwidth_3", (cmp_w - 66) / 4 - 30);
      dto.put("cmpwidth_4", (cmp_w - 66) / 4 - 30);
